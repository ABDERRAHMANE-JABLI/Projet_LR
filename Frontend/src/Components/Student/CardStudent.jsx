...
const CardStudent = ({photo, id, fullname, linkedin}) => {
    return (
        <div className="col">
            <div className="card h-100 text-center">
                <img src={photo} className="card-img-top" alt="profile" />
                ...
                <div className="card-footer d-flex justify-content-center">
                    ...
                    <a href={linkedin} className="me-2"><i className="bi bi-linkedin"></i></a>
                </div>
            </div>
        </div>
    )
